...
// pnp:/home/mamluk/Projects/preact-lazy-ssr/src/html.mjs
var html = ({ content: content2 }) => {
};
...
// pnp:/home/mamluk/Projects/preact-lazy-ssr/src/server.mjs
var jsx = () => /* @__PURE__ */ compat_default.createElement(compat_default.StrictMode, null, /* @__PURE__ */ compat_default.createElement(App, null));
var content = m3(jsx());
await writeFile(
  `dist/ssr/index.html`,
  html({ content })
